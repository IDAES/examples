...
see reaction package for documentation.}""",
    ...
    def build(self):
        ...
        # # Add single state block for aqueous phase
        # tmp_dict = dict(**self.config.aqueous_property_package_args)
        # tmp_dict["has_phase_equilibrium"] = False
        # tmp_dict["defined_state"] = False
        # self.aqueous_phase = self.config.aqueous_property_package.build_state_block(
        #     self.flowsheet().time, doc="Aqueous phase properties", **tmp_dict
        # )
